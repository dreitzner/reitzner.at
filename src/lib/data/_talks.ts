...
export const talks: Talk[] = [
	{
		...
		assets: [
			...
			{
				name: 'Slides',
				url: 'https://1drv.ms/p/c/061206b6a163fad0/EQpi7TDKExpNrTi2publcwABGJj466eRt1nLz5ZAsfdJRw',
			},
			{
				name: 'Svelte',
			...
			{
				name: 'KontentAi Custom Element',
				url: 'https://kontent.ai/learn/docs/apis/custom-elements-js-api',
			},
			{
				name: 'Svienna',
